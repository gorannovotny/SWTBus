...
public class Stupac {
	...
	public static void setVozniRed(Integer sifraVR) {
		try {
			String sql = "select a.ID,a.VozniRedID,a.VarijantaVRID,a.SmerVoznje,b.Opis1,b.Opis2,a.VremeOdhoda from PTStupciVR a,PTVozniRedi b WHERE a.VozniRedID = b.id AND b.ID = ? AND a.id NOT IN (select StupacID from PTStupciVRMirovanja WHERE DATE('now') BETWEEN OdDatuma AND DoDatuma) ORDER BY a.VremeOdhoda";
